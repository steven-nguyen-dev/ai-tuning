...
Layout:
- `core/constitution.md`, `core/working-lessons.md` — the shared discipline both skills and
  both subagents read first: the bar, A/B/C/D grades, the `[A]` test, failure modes, lessons.
