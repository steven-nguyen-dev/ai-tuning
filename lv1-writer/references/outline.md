...
Read `00-triage.md`, `01-research.md` (if it exists), `sources/library.md`, and
`manuscript/writing-instruction.md` (if it exists — its section-beat structure, if it
has one, can shape the Shape section below), then write `runs/<id>/02-outline.md`:
