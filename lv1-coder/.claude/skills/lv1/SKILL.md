---
name: lv1
description: Run a coding task through the full pipeline — triage, research, plan, build, independent inspection, and shipping with proof. Invoke explicitly with /lv1.
...
3. **Research.** Delegate to the `researcher` subagent. Do not proceed until facts
   with sources exist. Never let later steps build from memory.
